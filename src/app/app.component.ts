...
import { ionLogoGithub, ionLogoLinkedin, ionLogoSass } from '@ng-icons/ionicons';
...
export class AppComponent implements AfterViewInit {
  ...
  cards = [
    {title: 'Unreal Engine Developer', date: 'Oct 2020 - Present', place: 'realworld one', description: 'Collaborating with a team of 3D Artists and developers to provide interesting \n VR Trainings and Showrooms to a variety of clients from the life science sector'},
    {title: '3D Artist', date: 'Feb 2019 - June 2020', place: 'crossacitve gmbh', description: 'I developed the render Pipeline for 3D Product Visualizations. \n Furthermore I created said renderings for multiple beauty brands to \n populate their Amazon Product pages.'},
    {title: 'Game Art Tutor', date: 'Mai 2018 - Jan 2019', place: 'SAE Institute Cologne', description: 'I was responsible for teaching the students the basics of \n 3D modeling and Unreal Engine. I also supervised their projects \n which they had to submit.'},
    {title: 'B.A. Game Art & Animation', date: '2016 - 2018', place: 'Middlesex University', description: 'Studies that mainly focused on the Game Art Pipeline, where I specialised in the \n in the more technical aspects like Rigging, Scripting and Prototyping'}
  ];
